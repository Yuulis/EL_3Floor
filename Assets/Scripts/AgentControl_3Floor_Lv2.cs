...
public class AgentControl_3Floor_Lv2 : Agent
{
    // General
    ...
    {
        SpawnFloor = Random.Range(1, 3 + 1);
        if (SpawnFloor == 1) this.transform.localPosition = new Vector3(Random.Range(-19.5f, 19.5f), 4.95f, Random.Range(-14.5f, 14.5f));
        if (SpawnFloor == 2) this.transform.localPosition = new Vector3(Random.Range(-19.5f, 19.5f), 11.95f, Random.Range(-14.5f, 14.5f));
        if (SpawnFloor == 3) this.transform.localPosition = new Vector3(Random.Range(-19.5f, 19.5f), 18.95f, Random.Range(-14.5f, 14.5f));
    }
